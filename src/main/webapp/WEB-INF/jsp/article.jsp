...
<body class="logged-out  env-production windows">
    ...
    <div class="container-responsive">
        ...
        <div class="site-header-menu">
            ...
            <div class="site-header-actions">
                ...
                <a class="btn site-header-actions-btn mr-2" href="/login?return_to=%2Fblog" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
            </div>
    ...
    <div id="js-pjax-container" data-pjax-container>
        <div class="border-bottom py-4 mb-4 position-relative separation">
            <div class="container">
                ...
                <input class="form-control blog-search-input" type="text" name="q" id="blog-search" value="" tabindex="2">
            </form>
                <h1 class="my-0 blog-title-group">
                    <a href="/blog" class="blog-title">The GitHub Blog</a>
                </h1>
            </div>
        </div><!-- /.pagehead -->
        ...
        <div class="container" id="blog-main">
            <div class="blog-aside">
                <ul class="menu" role="navigation" data-pjax>
                    <a href="/blog" aria-selected="true" class="js-selected-navigation-item selected menu-item" data-selected-links=" /blog">Featured</a>
            ...
            <div class="blog-content">
                ...
                <div class="posts">
                    <div class="hentry blog-post">
                        <h2 class="blog-post-title lh-condensed" data-pjax>
                            <a href="/blog/2267-introducing-github-community-guidelines" rel="bookmark">Introducing GitHub Community Guidelines</a>
                        </h2>

                        <ul class="blog-post-meta">
                            <li class="meta-item">
                                <svg aria-hidden="true" class="octicon octicon-calendar" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path d="M13 2h-1v1.5c0 .28-.22.5-.5.5h-2c-.28 0-.5-.22-.5-.5V2H6v1.5c0 .28-.22.5-.5.5h-2c-.28 0-.5-.22-.5-.5V2H2c-.55 0-1 .45-1 1v11c0 .55.45 1 1 1h11c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 12H2V5h11v9zM5 3H4V1h1v2zm6 0h-1V1h1v2zM6 7H5V6h1v1zm2 0H7V6h1v1zm2 0H9V6h1v1zm2 0h-1V6h1v1zM4 9H3V8h1v1zm2 0H5V8h1v1zm2 0H7V8h1v1zm2 0H9V8h1v1zm2 0h-1V8h1v1zm-8 2H3v-1h1v1zm2 0H5v-1h1v1zm2 0H7v-1h1v1zm2 0H9v-1h1v1zm2 0h-1v-1h1v1zm-8 2H3v-1h1v1zm2 0H5v-1h1v1zm2 0H7v-1h1v1zm2 0H9v-1h1v1z"></path></svg>
                                October 19, 2016
                            </li>

                            <li class="fn meta-item">
                                <img alt="@balevine" class="author-avatar" height="18" src="https://avatars0.githubusercontent.com/u/2433775?v=3&amp;s=36" width="18" /> <a href="/balevine">balevine</a>
                            </li>
                ...
                <div class="blog-feedback">
                    <h2 class="blog-feedback-header with-twitter">
                        Have feedback on this post? Let <a href="https://twitter.com/intent/tweet?text=@github%20&amp;related=github&amp;url=https://github.com/blog/2267-introducing-github-community-guidelines" target="blank">@github</a> know on Twitter.
                    </h2>
